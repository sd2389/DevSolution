...
export function Hero({ title, subtitle, primaryCTA, secondaryCTA }: HeroProps) {
  return (
    <div className="relative isolate">
      ...
      >
        <div
          className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-primary to-gold opacity-20 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
          style={{
            clipPath:
